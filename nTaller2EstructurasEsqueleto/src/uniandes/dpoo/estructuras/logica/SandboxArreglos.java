...
public class SandboxArreglos
{
    ...
    public void insertarEntero( int entero, int posicion )
    {
    	if (posicion < 0) {
            ...
            System.out.println("Índice fuera de los límites del arreglo. Inserción en el final.");
    ...
    {
    	System.out.println("Contenido del arreglo: " + Arrays.toString(arregloEnteros));
